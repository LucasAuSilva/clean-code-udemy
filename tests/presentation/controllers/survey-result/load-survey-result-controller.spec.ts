import { LoadSurveyResultController, LoadSurveyResultControllerDto } from '@/presentation/controllers/survey-result'
...
const mockRequest = (): LoadSurveyResultControllerDto => ({
